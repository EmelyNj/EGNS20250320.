...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__Brands__DAD4F3BE44874E15");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6ED638450DD");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCACB1847BE0");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D10534E72005C8").IsUnique();
        ...
        {
            entity.HasKey(e => e.WarehouseId).HasName("PK__Warehous__2608AFD9DBCEA97A");
